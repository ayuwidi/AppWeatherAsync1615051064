...
const mainIcon = require('./img/main1.png');
const levelIcon = require('./img/sea2.png');
...
getWeather= () => {
  let url = 'http://api.openweathermap.org/data/2.5/weather?q='+ this.state.city + '&appid=13af4f6dc945bd9db95625de88104966&units&units=metric';
  fetch(url)
